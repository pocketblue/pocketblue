...
install -Dm 0755 $DEVICE_PATH/scripts/flash-xiaomi-pipa.sh $OUT_PATH/flash-xiaomi-pipa.sh
install -Dm 0755 $DEVICE_PATH/scripts/flash-xiaomi-pipa.cmd $OUT_PATH/flash-xiaomi-pipa.cmd
